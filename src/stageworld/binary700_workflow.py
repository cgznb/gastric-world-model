...
from stageworld.binary700_evaluation import evaluate
from stageworld.binary700_inference import export_bundle, predict_bundle
from stageworld.binary700_models import AnchoredClassifier, world_loss
from stageworld.binary700_spec import NEURAL, SEEDS, STATISTICAL, Candidate, specification
...
def _ct_report(
    ...
    prediction = infer(model, x, pool, rows, world=True)
            ...
            for candidate in NEURAL:
                ...
                if not (target / "completed.json").exists():
                    ...
                    atomic_write_private_json(
                        ...
                        {"inner": inner_report, "refit": refit_report, "rules": rules},
                    )
                    export_bundle(
                        target / "bundle",
                        s_refit,
