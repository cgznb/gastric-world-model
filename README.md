...
本研究分支提供 **Event V2 与原 Event Multistage 的十种子内部留出比较**，
每个种子独立划分训练、验证、测试。原 complete651 五折协议和更早版本保留为对照。
...
本轮40个训练阶段和最终审计均已完成。V2相对V1的复发AUPRC在3个种子提高、7个下降，
pCR AUROC在7个提高、3个下降；目前不能认定新结构改善了复发主终点。
实际结果和局限见 [设计文档第9节](docs/EVENT_V2_RESEARCH.md#9-本轮训练与测试结果)，
软件和GPU复核见 [验证记录](docs/VALIDATION.md)。
